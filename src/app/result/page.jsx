      ...
      >
        <TableHead>
          <TableRow>
            ...
            <TableCell rowSpan={2}>代號</TableCell>
            ...
            return (
              <>
                ...
                >
                  ...
                  <TableCell rowSpan={rowSpan}>{row.course_code}</TableCell>
                  ...
                  <TableCell rowSpan={rowSpan}>{row.lecturing_hours}</TableCell>
                  ...
                  <TableCell rowSpan={rowSpan}>
                    ...
                    >
                      ...
                      />
                      <input type="hidden" name="arg04" value={row.syllabus} />
                      <Button
                        type="submit"
                        variant="outlined"
                        color="secondary"
